  ...
  return (
    <ServiceSection id="services">
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Design"
          title={<h1>We digitize you</h1>}
          subText={
            <h3>
              We help clients attract more customers by using latest strategies.
            </h3>
          }
        />
        <OBJ>
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Develop"
          title={<h1>We increase your digital presence</h1>}
          subText={
            <h5>
              We build appropriate solution to advertise you digitally and hence increase your revenue with the best tools available
            </h5>
          }
        />
        <OBJ>
